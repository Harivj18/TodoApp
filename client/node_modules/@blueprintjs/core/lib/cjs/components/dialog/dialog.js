...
var Dialog = /** @class */ (function (_super) {
    ...
    Dialog.prototype.render = function () {
        var _a, _b;
        var _c = this.props, className = _c.className, children = _c.children, containerRef = _c.containerRef, style = _c.style, title = _c.title, _d = _c.role, role = _d === void 0 ? "dialog" : _d, overlayProps = tslib_1.__rest(_c, ["className", "children", "containerRef", "style", "title", "role"]);
        return (React.createElement(overlay2_1.Overlay2, tslib_1.__assign({}, overlayProps, { className: common_1.Classes.OVERLAY_SCROLL_CONTAINER, childRef: this.childRef, hasBackdrop: true }),
            React.createElement("div", { className: common_1.Classes.DIALOG_CONTAINER, ref: containerRef === undefined ? this.childRef : (0, common_1.mergeRefs)(containerRef, this.childRef) },
                React.createElement("div", { className: (0, classnames_1.default)(common_1.Classes.DIALOG, className), role: role, "aria-modal": (_a = overlayProps.enforceFocus) !== null && _a !== void 0 ? _a : (_b = overlay2_1.Overlay2.defaultProps) === null || _b === void 0 ? void 0 : _b.enforceFocus, "aria-labelledby": this.props["aria-labelledby"] || (title ? this.titleId : undefined), "aria-describedby": this.props["aria-describedby"], style: style },
