...
export class Dialog extends AbstractPureComponent {
    ...
    render() {
        ...
        return (React.createElement(Overlay2, { ...overlayProps, className: Classes.OVERLAY_SCROLL_CONTAINER, childRef: this.childRef, hasBackdrop: true },
            React.createElement("div", { className: Classes.DIALOG_CONTAINER, ref: containerRef === undefined ? this.childRef : mergeRefs(containerRef, this.childRef) },
                React.createElement("div", { className: classNames(Classes.DIALOG, className), role: role, "aria-modal": overlayProps.enforceFocus ?? Overlay2.defaultProps?.enforceFocus, "aria-labelledby": this.props["aria-labelledby"] || (title ? this.titleId : undefined), "aria-describedby": this.props["aria-describedby"], style: style },
